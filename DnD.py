                ...
                if classes==1:
                    ...
                    if attack=='Fireball' and MPh>=2:
                        ...
                        if l<10:
                            ...
                            if crit==10:
                                zomb1=zomb1-4*intel
                                print("The zombie tried to run away and hide behind a corner. Unfortunately for it, by running away, it ran exactly in the trajectory of your fireball and it hit for twice the damage!")
                            else:
                                zomb1=zomb1-2*intel
                        elif 19<l<30:
                            crit=rnd.randint(1, 10)
                        ...
                        if d==1:
                            if l<10:
                                ...
                                if crit==10:
                                    ...
                                    zomb2=zomb2-2*intel
                                    zomb1=zomb1-2*intel
                                    print("The zombies getting scared by the electric feeling, tried to run away but fell in a puddle! It did twice the damage!")
                                else:
                                    zomb6=zomb6-intel
                                    zomb5=zomb5-intel
                                    zomb4=zomb4-intel
                            ...
                            if zomb==1:
                                if l<10:
                                    ...
                                    if crit==10:
                                        zomb1=zomb1-2*intel
                                        print("The zombie getting scared by the electric feeling, tried to run away but fell in a puddle! It did twice the damage!")
                                    else:
                                        zomb1=zomb1-intel
                                elif 19<l<30:
                                    crit=rnd.randint(1, 10)
                        ...
                        if d==1:
                            if l<10:
                                ...
                                if crit==10:
                                    ...
                                    print("The slimes couldn't see you so they jumped up. Unfortunately for them, they landed in the middle of your spell, dealing twice as much damage!")
                                else:
                                    slime9=slime9-intel
                                    slime8=slime8-intel
                                    slime7=slime7-intel
                            ...
                            if slime==3:
                                ...
                                if l<10:
                                    ...
                                    if crit==10:
                                        slime1=slime1-2*intel
                                        print("The slime couldn't see you so it jumped up. Unfortunately for it, it landed in the middle of your spell, dealing twice as much damage!")
                                    else:
                                        slime1=slime1-intel
                                elif 19<l<30:
                                    crit=rnd.randint(1, 10)
                    ...
                    if mgob>0:
                        if l<10:
                            ...
                            if crit==10:
                                mgob1=mgob1-4*intel
                                if mgob>0:
                                    print("The mage goblin thought you were launching a water spell and threw a plant type spell. Unfortunately, it caught fire and delt twice as much damage!")
                    ...
                    if mgob==3:
                        if l<10:
                            ...
                            if crit==10:
                                ...
                                print("The goblin king tried to avoid your attack but ran right into it dealing double the damage!")
                            else:
                                mgob3=mgob3-intel
                                mgob2=mgob2-intel
                                mgob1=mgob1-intel
                        ...
                        if l<10:
                            ...
                            if crit==10:
                                ...
                                HPgoblinking-=2*intel
                                if mgob>0:
                                    print("The mage goblin thought you were firing a fire type spell and protected himself with water. As you expect, it did twice the amount of damge!")
                                print("The goblin king tried to avoid your attack but ran right into it dealing double the damage!")
                            else:
                                mgob1=mgob1-intel
                                HPgoblinking-=intel
